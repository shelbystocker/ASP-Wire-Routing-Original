...
# generate wires
rx1 = random.randint(1,20)
ry1 = random.randint(1,20)
R1 = str(rx1) + str(ry1)
rx2 = random.randint(1,20)
ry2 = random.randint(1,20)
R2 = str(rx2) + str(ry2)
...
rx3 = random.randint(1,20)
ry3 = random.randint(1,20)
R3 = str(rx3) + str(ry3)
...
gx1 = random.randint(1,20)
gy1 = random.randint(1,20)
G1 = str(gx1) + str(gy1)
...
gx2 = random.randint(1,20)
gy2 = random.randint(1,20)
G2 = str(gx2) + str(gy2)
...
gx3 = random.randint(1,20)
gy3 = random.randint(1,20)
G3 = str(gx3) + str(gy3)
...
condition4 = True
while condition4:
        if G1==G3 or G1==G2 or G3==R1 or G3==R2 or G3==R3:
                gx3 = random.randint(1,20)
                gy3 = random.randint(1,20)
                G3 = str(gx3) + str(gy3)
        else:
...
for i in range(numBlocks):
	condition5 = True
	while condition5:
		blockX = random.randint(1,20)
		blockY = random.randint(1,20)
